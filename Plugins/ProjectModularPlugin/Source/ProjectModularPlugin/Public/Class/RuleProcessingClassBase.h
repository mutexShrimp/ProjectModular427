...
public:	
	...
	TArray<FRule> InitializeRuleProcessor(UModuleComponent* ModuleComponent, UModuleComponent* PreviousComponent, const FModulesMapWrapper& NewModules);
	virtual TArray<FRule> InitializeRuleProcessor_Implementation(UModuleComponent* ModuleComponent, UModuleComponent* PreviousComponent, const FModulesMapWrapper& NewModules);
	
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Function", meta=(Keywords="Add Rule Processer"))
	TArray<FRule> AddRuleProcessor(UModuleComponent* ModuleComponent, UModuleComponent* PreviousComponent, const FModulesMapWrapper& NewModules);
	virtual TArray<FRule> AddRuleProcessor_Implementation(UModuleComponent* ModuleComponent, UModuleComponent* PreviousComponent, const FModulesMapWrapper& NewModules);

	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Function", meta=(Keywords="Add Rule Processer"))
	TArray<FRule> AbbRuleProcessor(const FModulesMapWrapper& NewModules);
	virtual TArray<FRule> AbbRuleProcessor_Implementation(const FModulesMapWrapper& NewModules);
