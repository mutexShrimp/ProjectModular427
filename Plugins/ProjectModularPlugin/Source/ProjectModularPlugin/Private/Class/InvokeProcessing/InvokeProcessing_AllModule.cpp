...
void UInvokeProcessing_AllModule::InvokeProcessing_Implementation(UModuleComponent* ModuleComponent,
	UModuleComponent* PreviousComponent, const FModulesMapWrapper& NewModules, FRule Rule)
{
	...
	for (TTuple<FString, TScriptInterface<IModuleClassInterface>> NewModule : NewModules.NewModules)
	{
